...
public class CrudHelper {
    ...
    public ArrayList<HashMap<String, String>> getMahasiswa(@Nullable String _id) {
        ...
        if (_id != null) {
            ...
            selection =
                    DatabaseContract.TbMahasiswa.TABLE_NAME + "." + DatabaseContract.TbMahasiswa.COLUMN_NAME_ID_DOSENPA +
                            " = " + //mahasiswa.id_dosenpa =
                            DatabaseContract.TbDosen.TABLE_NAME + "." + DatabaseContract.TbDosen._ID + " AND " + //dosen.id and

                            DatabaseContract.TbMahasiswa.TABLE_NAME + "." + BaseColumns._ID +
                            " = ? AND "+ //mahasiswa.id = ? and

                            DatabaseContract.TbMahasiswa.TABLE_NAME +"." +DatabaseContract.TbMahasiswa.COLUMN_NAME_ID_JURUSAN+
                            " = "+ //mahasiswa.id_jurusan =
                            DatabaseContract.TbJurusan.TABLE_NAME +"."+DatabaseContract.TbJurusan._ID; //jurusan.id
        }
//menggunakan contoh join
        ...
        //Cursor cursor = db.rawQuery("Select m._id, m.nama as NamaMhs, m.email, d.nama as DosenPA, j.nama as Jurusan FROM mahasiswa m JOIN dosen d ON m.id_dosenpa = d._id JOIN jurusan j ON m.id_jurusan = j._id",null);
        ...
        while (cursor.moveToNext()) {
            ...
            HashMap<String, String> mahasiswa = new
    ...
    public ArrayList<HashMap<String, String>> getDosen(@Nullable String _id) {
        ...
        Cursor cursor = db.query(
                DatabaseContract.TbDosen.TABLE_NAME + "", // The table
//to query
...
//clause
        ...
        ArrayList<HashMap<String, String>> Jurusans = new
                ArrayList<HashMap<String, String>>();
        while (cursor.moveToNext()) {
            String id = cursor.getString(
