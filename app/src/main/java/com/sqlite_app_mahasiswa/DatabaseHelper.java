...
//increment the database version.
    ...
    private static final String SQL_CREATE_TbDOSEN =
            "CREATE TABLE " +
                    DatabaseContract.TbDosen.TABLE_NAME + " (" +
                    DatabaseContract.TbDosen._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + DatabaseContract.TbDosen.COLUMN_NAME_NAMA + " TEXT," +DatabaseContract.TbDosen.COLUMN_NAME_EMAIL + " TEXT)";
    private static final String SQL_CREATE_TbJURUSAN =
            String.format("CREATE TABLE %s (%s INTEGER PRIMARY KEY AUTOINCREMENT,%s TEXT)",
                    DatabaseContract.TbJurusan.TABLE_NAME,
                    DatabaseContract.TbJurusan._ID,
                    DatabaseContract.TbJurusan.COLUMN_NAME_NAMA
                    );
    private static final String SQL_DELETE_TbMahasiswa =
            "DROP TABLE IF EXISTS " +
                    DatabaseContract.TbMahasiswa.TABLE_NAME;
    private static final String SQL_DELETE_TbDosen =
            "DROP TABLE IF EXISTS " +
                    DatabaseContract.TbDosen.TABLE_NAME;
    private static final String SQL_DELETE_TbJurusan = "" +
            "DROP TABLE IF EXISTS " +
                    DatabaseContract.TbJurusan.TABLE_NAME;
}